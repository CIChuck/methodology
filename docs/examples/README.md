...
Example artifacts demonstrate how the methodology can be applied, but they are not active project
authority for a new clone.

Do not use example source paths, test names, CLI commands, implementation evidence, or traceability
